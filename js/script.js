...
function initCategories() {
    const categories = [
        { id: 'animals', name: 'Животные', emoji: '🐾', color: '#FFEAA7', words: 203 },
        { id: 'food_and_drinks', name: 'Еда и напитки', emoji: '🥗🥤', color: '#B4E4FF', words: 158 },
        { id: 'geography', name: 'География', emoji: '🗺️', color: '#D0B7FF', words: 204 },
        { id: 'adult_items', name: '18+', emoji: '🔞', color: '#FFB5B5', words: 60 },
        { id: 'science', name: 'Наука', emoji: '🧬', color: '#BFF0C2', words: 188 },
        { id: 'cinema', name: 'Кино', emoji: '🎬', color: '#FBC8D5', words: 199 },
        { id: 'history', name: 'История', emoji: '📜', color: '#5e4e81', words: 101 },
        { id: 'music', name: 'Музыка', emoji: '🎸', color: '#b39442', words: 154 },
        { id: 'memes', name: 'Мемы', emoji: '🤡', color: '#b34264', words: 131 }
    ];
        ...
        <div class="category-card" data-category="${cat.id}">
            ...
            <div class="category-info">
                <div class="category-name-wrapper">
                    ...
                    <span class="category-words-count">${cat.words} ${getWordEnding(cat.words)}</span>
                </div>
...
function collectWords() {
    ...
    appState.selectedCategories.forEach(category => {
        if (WORDS_DATABASE[category]) {
            words = [...words, ...WORDS_DATABASE[category]];
        }
    });
